...
def get_high_state_lengths_data(data):
...
def calculate_bits(high_state_lengths_data):
    # 找到最长和最短的时长
...
class DHT11(object):
    ...
    def read_DHT(self):
        ...
        high_state_lengths_data = get_high_state_lengths_data(data)
        ...
        # 根据上升脉冲的长度计算二进制bit
        bits = calculate_bits(high_state_lengths_data)
